-- venyx ui lib
-- Reuploaded by unknown
-- remade for water's dupe script
-- init
...
local themes = {
    ...
    LightContrast = Color3.fromRGB(22, 27, 34),
    DarkContrast = Color3.fromRGB(6, 11, 17),
    TextColor = Color3.fromRGB(201, 209, 217)
}
